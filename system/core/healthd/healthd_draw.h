...
class HealthdDraw {
 public:
  ...
  // Redraws screen.
  void redraw_screen(const animation* batt_anim, bool charger_connected);
 ...
 protected:
  ...
  virtual void draw_battery(const animation* anim, bool charger_connected);
  virtual void draw_surface_percent_number(GRSurface* surface,int basecount,int offect);
  virtual int draw_surface_percent_symbol(GRSurface* surface,int offect);
  virtual void draw_percent(GRSurface *surface,int value,int basecount,int offect);
  virtual void select(const animation* batt_anim, int x, int y, int z);
  virtual void draw_power_percent(const animation* batt_anim);
