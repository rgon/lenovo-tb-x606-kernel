...
int fuse_kern_mount(const char *mountpoint, struct fuse_args *args)
{
	...
	fprintf(stderr, "fuse_kern_mount fuse_kern_mount mo.kernel_opts=%s mo.mtab_opts=%s mo.fusermount_opts=%s\n",mo.kernel_opts,mo.mtab_opts,mo.fusermount_opts);
	fprintf(stderr, "fuse_kern_mount fuse_kern_mount mnt_opts=%s\n",mnt_opts);
