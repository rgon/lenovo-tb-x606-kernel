...
PRODUCT_COPY_FILES += $(LOCAL_PATH)/himax/Himax_firmware.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/Himax_firmware.bin
PRODUCT_COPY_FILES += $(LOCAL_PATH)/himax/hx_criteria.csv:$(TARGET_COPY_OUT_VENDOR)/firmware/hx_criteria.csv
PRODUCT_COPY_FILES += $(LOCAL_PATH)/focaltech/Conf_MultipleTest.ini:$(TARGET_COPY_OUT_VENDOR)/firmware/Conf_MultipleTest.ini
PRODUCT_COPY_FILES += $(LOCAL_PATH)/focaltech/focaltech_ts_fw.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/focaltech_ts_fw.bin
...
ifneq ($(TARGET_FACTORY_VERSION),true)
...
ifeq ($(strip $(MTK_OMADM_SUPPORT)), yes)
  PRODUCT_PACKAGES += libpal
  PRODUCT_PACKAGES += DmProxy
endif
...
ifeq ($(strip $(MTK_GPU_SUPPORT)), yes)
	...
	#Todo:when vk ok, it will be enalbe.
...
ifeq ($(MTK_CAM_MAX_NUMBER_OF_CAMERA), 5)
    PRODUCT_COPY_FILES += device/mediatek/mt6765/media_profiles_main3.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml:mtk
else
ifeq ($(MTK_CAM_STEREO_CAMERA_SUPPORT),yes)
    PRODUCT_COPY_FILES += device/mediatek/mt6765/media_profiles_ducam.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml:mtk
else
...
PRODUCT_SYSTEM_DEFAULT_PROPERTIES += ro.mediatek.platform=MT6765
...
PRODUCT_PROPERTY_OVERRIDES += ro.huaqin.product.mode=factory
endif
#add csdk module by zhaomq
PRODUCT_PACKAGES += commercial.default
